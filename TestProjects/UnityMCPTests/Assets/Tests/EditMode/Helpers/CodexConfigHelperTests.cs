...
namespace MCPForUnityTests.Editor.Helpers
{
    public class CodexConfigHelperTests
    {
        ...
        /// --from, a matching UnityMCPBridge server source, and the mcp-for-unity package name.
        /// </summary>
        private static void AssertValidUvxArgs(TomlArray args)
        {
            ...
            Assert.IsTrue(
                argValues.Any(a => a.Contains("gitgomez/UnityMCPBridge") && a.Contains("#subdirectory=Server")),
                "Args should contain the matching UnityMCPBridge Git server source");
