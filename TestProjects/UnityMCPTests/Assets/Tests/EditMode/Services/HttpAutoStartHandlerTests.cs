...
namespace MCPForUnityTests.Editor.Services
{
    ...
    public class HttpAutoStartHandlerTests
    {
        ...
        [Test]
        public void IsConnectPending_ReflectsSharedStartupMarker()
        {
            Assert.IsFalse(HttpAutoStartHandler.IsConnectPending);

            SessionState.SetBool(HttpAutoStartHandler.ConnectPendingKey, true);

            Assert.IsTrue(HttpAutoStartHandler.IsConnectPending);
        }
