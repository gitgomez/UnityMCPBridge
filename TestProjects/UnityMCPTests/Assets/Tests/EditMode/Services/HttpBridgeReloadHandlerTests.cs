...
namespace MCPForUnityTests.Editor.Services
{
    ...
    public class HttpBridgeReloadHandlerTests
    {
        ...
        public void BeforeReloadCore_BridgeRunning_SetsFlagAndForceStops()
        {
            ...
            Assert.AreEqual(1, _fakeClient.ReloadNotifications);
            Assert.AreEqual("assembly_reload", _fakeClient.LastReloadReason);
        ...
        public void BeforeReloadCore_BridgeNotRunning_PreservesPendingFlag()
        {
            ...
            Assert.AreEqual(0, _fakeClient.ReloadNotifications,
                "a bridge that is already down must not announce another reload");
        }
