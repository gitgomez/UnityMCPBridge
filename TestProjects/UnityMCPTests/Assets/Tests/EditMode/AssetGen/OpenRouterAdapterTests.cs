...
namespace MCPForUnityTests.Editor.AssetGen
{
    public class OpenRouterAdapterTests
    {
        ...
        public void Submit_ImageMode_LocalPath_SendsDataUri()
        {
            ...
            {
                try { Directory.Delete(Path.Combine(ProjectRoot(), "Assets/Generated/__assetgen_openrouter_adapter"), true); } catch { }
                CleanupEmptyParentFolders("Assets/Generated/__assetgen_openrouter_adapter");
            }
        }
