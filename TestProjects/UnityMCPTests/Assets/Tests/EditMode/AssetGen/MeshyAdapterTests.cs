...
namespace MCPForUnityTests.Editor.AssetGen
{
    ...
    public class MeshyAdapterTests
    {
        ...
        public void Submit_ImageMode_LocalPath_SendsDataUri()
        {
            ...
            {
                try { Directory.Delete(Path.Combine(ProjectRoot(), "Assets/Generated/__assetgen_meshy_adapter"), true); } catch { }
                CleanupEmptyParentFolders("Assets/Generated/__assetgen_meshy_adapter");
            }
        }
