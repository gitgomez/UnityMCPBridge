...
For development snapshots, replace `v10.2.7` with `optimize/bridge` in both the server source and Unity package URL. Moving-branch installations are not reproducible and can change without notice.
