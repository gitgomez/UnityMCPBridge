...
@mcp_for_unity_tool(
    ...
    description=(
        ...
        "   - In play mode: keeps the PlayerLoop active while the Editor is unfocused, waits asynchronously for "
        "WaitForEndOfFrame, and returns the completed PNG in one call while restoring the previous background setting.\n"
