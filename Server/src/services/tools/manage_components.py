...
@mcp_for_unity_tool(
    description=(
        ...
        "Actions: add, remove, set_property. Requires target (instance ID, name/path, or scene-object handle) and component_type. "
...
async def manage_components(
    ...
    target: Annotated[
        ...
        "Target GameObject - Runtime v1 scene-object handle (reload-stable when it contains a GlobalObjectId), instance ID, or name/path"
    ],
    ...
    value: Annotated[Optional[str | int | float | bool | dict | list],
                     ...
                     "For object references: scene-object handle, instance ID (int), asset path (string), "
                     "or {\"guid\": \"...\"} / {\"path\": \"...\"}. "
