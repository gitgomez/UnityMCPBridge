...
async def manage_gameobject(
    ...
    target: Annotated[str | dict[str, Any],
                      "GameObject identifier by name, path, instance ID, or Runtime v1 scene-object handle for modify/delete/duplicate actions"] | None = None,
    ...
    parent: Annotated[str | dict[str, Any],
                      "Parent GameObject reference or Runtime v1 scene-object handle - used for create/modify"] | None = None,
    ...
    reference_object: Annotated[str | dict[str, Any],
    ...
    look_at_target: Annotated[list[float] | str | dict[str, Any],
                              "World position [x,y,z], GameObject name/path/ID, or Runtime v1 handle to look at."] | None = None,
    look_at_up: Annotated[list[float] | str,
                          "Optional up vector [x,y,z] for look_at. Defaults to [0,1,0]."] | None = None,
    if_match: Annotated[dict[str, Any],
                        "Optional Runtime v1 state precondition from a prior response.state"] | None = None,
) -> dict[str, Any]:
