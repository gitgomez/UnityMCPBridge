...
async def test_editor_state_v2_is_registered_and_has_contract_fields(monkeypatch):
            ...
            "data": {
                ...
                "assets": {
                    "last_editor_save": {
                        ...
                        "mtime_unix_ns": 1750000000123456700,
                        "mtime_unix_100ns": 17500000001234567,
                        "file_size_bytes": 4096,
                        "saved_unix_ms": 1750000000123,
                    },
                    "editor_save_receipts": [
                        {
                            "epoch": "editor-epoch",
                            "sequence": 3,
                            "kind": "scene",
    ...
    assert data["assets"]["last_editor_save"]["sequence"] == 3
    assert data["assets"]["editor_save_receipts"][0]["kind"] == "scene"
