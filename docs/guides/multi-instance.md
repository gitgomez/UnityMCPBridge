...
- [`set_active_instance`](../reference/tools/core/set_active_instance.md) — full tool reference
- [`unity_instances` resource](../reference/resources/index.md) — discovery surface
