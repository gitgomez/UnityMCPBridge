...
| `target` | `str \| int \| dict[str, Any]` | yes | Target GameObject - Runtime v1 scene-object handle (reload-stable when it contains a GlobalObjectId), instance ID, or name/path |
...
| `value` | `str \| int \| float \| bool \| dict \| list \| None` | — | Value to set (for set_property action). For object references: scene-object handle, instance ID (int), asset path (string), or {"guid": "..."} / {"path": "..."}. For Sprite sub-assets: {"guid": "...", "spriteName": "<name>"} or {"guid": "...", "fileID": <id>}. Single-sprite textures auto-resolve. |
