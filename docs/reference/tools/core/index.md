...
- **[`audit_project`](./audit_project.md)** — Run read-only Unity project health checks and return a structured, paginated report.
...
- **[`manage_input`](./manage_input.md)** — Create, inspect, validate, and modify Unity Input System .inputactions assets.
