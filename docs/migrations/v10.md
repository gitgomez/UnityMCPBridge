...
This Unity-6-only line adopts an explicit modern compatibility floor:

- Unity 6.0 is the package floor.
- Unity 6.0 LTS and a rolling Unity 6.x editor form the supported matrix.
...
- [Tool groups](../guides/tool-groups.md)
- [Asset generation tools](../reference/tools/asset_gen/index.md)
- [`generate_model`](../reference/tools/asset_gen/generate_model.md)
- [`generate_image`](../reference/tools/asset_gen/generate_image.md)
- [`import_model`](../reference/tools/asset_gen/import_model.md)
- [`import_model_file`](../reference/tools/asset_gen/import_model_file.md)
- [Generated tool reference](../reference/tools/index.md)
- [Unity compatibility shims](../architecture/unity-compat.md)
- [Project roadmap](../architecture/project-roadmap.md)
