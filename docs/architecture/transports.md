...
- A small amount of setup complexity if you bind to LAN — see [Security](https://github.com/gitgomez/UnityMCPBridge/blob/main/SECURITY.md)
...
See [Multi-Instance Routing](../guides/multi-instance.md) for the routing API.
...
- v8 migration notes: [/migrations/v8](../migrations/v8.md) — the architectural story of HTTP arriving
