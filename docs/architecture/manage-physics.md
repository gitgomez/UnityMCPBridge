...
| Action | Description |
|--------|-------------|
| `create_physics_material` | Create PhysicsMaterial (3D) or PhysicsMaterial2D assets with friction/bounciness/combine modes |
...
- **Unity 6 APIs**: Uses `linearDamping`, `angularDamping`, `linearVelocity`, and `PhysicsMaterial` directly
