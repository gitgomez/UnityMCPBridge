...
namespace MCPForUnity.Editor.Clients
{
    ...
    public abstract class McpClientConfiguratorBase : IMcpClientConfigurator
    {
        ...
        {
            // Includes an explicit override or the matching stable/development fork source.
        ...
        /// - Git integration branch: contains "@optimize/bridge"
        /// - Git beta branch: contains "@beta" or "-beta" (upstream compatibility)
        /// </summary>
        protected static bool IsBetaPackageSource(string packageSource)
        {
            ...
            if (packageSource.Contains("@optimize/bridge", StringComparison.OrdinalIgnoreCase))
                return true;
    ...
    public abstract class ClaudeCliMcpConfigurator : McpClientConfiguratorBase
    {
        ...
        /// The output format includes args like: --from "git+https://...#subdirectory=Server"
        /// </summary>
