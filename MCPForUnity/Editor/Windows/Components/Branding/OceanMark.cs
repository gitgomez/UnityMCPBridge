...
namespace MCPForUnity.Editor.Windows.Components.Branding
{
    ...
    ///
    /// Drawn as resolution-independent vector geometry via UI Toolkit's Painter2D — crisp at
    /// any DPI, theme-independent, and with no package dependency.
    ///
    /// Geometry is transcribed from docs/images/logo-mark.svg (viewBox "30 30 140 140"),
