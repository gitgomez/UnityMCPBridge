...
namespace MCPForUnity.Editor.Services
{
    ...
    public class PackageUpdateService : IPackageUpdateService
    {
        ...
        private const string MainPackageJsonUrl = "https://raw.githubusercontent.com/gitgomez/UnityMCPBridge/main/MCPForUnity/package.json";
        private const string BetaPackageJsonUrl = "https://raw.githubusercontent.com/gitgomez/UnityMCPBridge/optimize/bridge/MCPForUnity/package.json";
        private const string AssetStoreVersionUrl = "https://raw.githubusercontent.com/CoplayDev/unity-mcp/main/MCPForUnity/package.json";
        ...
        public string GetGitUpdateBranch(string currentVersion)
        {
            try
            {
                ...
                if (packageId.IndexOf("#beta", StringComparison.OrdinalIgnoreCase) >= 0 ||
                    packageId.IndexOf("#optimize/bridge", StringComparison.OrdinalIgnoreCase) >= 0)
                {
                    return "beta";
                }
        ...
        protected virtual string FetchLatestVersionFromGitHub(string branch)
        {
            try
            {
                ...
                // https://api.github.com/repos/gitgomez/UnityMCPBridge/releases/latest
                //
