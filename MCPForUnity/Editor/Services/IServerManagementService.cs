namespace MCPForUnity.Editor.Services
{
    ...
    public interface IServerManagementService
    {
        ...
        /// per-port launch log. Reuses an already reachable or in-flight managed server; otherwise
        /// stops stale server state on the port and clears stale artifacts first.
        /// </summary>
        ...
        /// <summary>
        /// Returns true when the managed launcher has exited with a non-zero exit code.
        /// A successful launcher hand-off (exit code 0) is not treated as a server failure.
        /// </summary>
        bool HasManagedServerLaunchFailed();
