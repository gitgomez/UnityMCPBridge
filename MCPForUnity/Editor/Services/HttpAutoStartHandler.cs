...
namespace MCPForUnity.Editor.Services
{
    ...
    internal static class HttpAutoStartHandler
    {
        ...
        internal static bool IsConnectPending => SessionState.GetBool(ConnectPendingKey, false);
        ...
        /// process is alive, keep polling reachability and declare failure only when the launcher
        /// reports a non-zero exit code. A zero exit may represent a successful process hand-off.
        /// Without a launch handle (post-reload reconnect, or an external server) poll to the hard cap.
        /// </summary>
