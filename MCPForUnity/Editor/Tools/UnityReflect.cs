...
namespace MCPForUnity.Editor.Tools
{
    ...
    public static class UnityReflect
    {
        ...
        private static object GetTypeInfo(ToolParams p)
        {
            ...
            // Open generic type definitions can make member reflection unstable across Unity's
            // Mono/CoreCLR transition. Return minimal info using only safe property accesses.
