...
namespace MCPForUnity.Editor.Helpers
{
    ...
    public static class ObjectResolver
    {
        ...
        {
            return Resolve(instruction, typeof(T), includeInactive: false) as T;
        }
        ...
        {
            return Resolve(instruction, targetType, includeInactive: false);
        }
            ...
            bool includeInactive)
        {
            ...
            // --- Scene Object Search ---
            GameObject foundGo = GameObjectLookup.FindByTarget(
                new JValue(findTerm),
                searchMethodToUse,
                includeInactive);
            ...
            bool includeInactive = false)
        {
            ...
            if (target.Type != JTokenType.Object)
            {
                ...
                return GameObjectLookup.FindByTarget(
                    target,
