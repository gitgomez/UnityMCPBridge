...
namespace MCPForUnity.Editor.Helpers
{
    public static class ConfigJsonBuilder
    {
        ...
        {
            // Local source trees use an isolated reinstall with no cache so an unchanged
            // package version cannot reuse an older tool environment. The explicit remote
            // refresh toggle keeps the lighter --no-cache --refresh behavior.
