namespace MCPForUnity.Runtime.Helpers
{
    ...
    /// the package targets (Unity 6.0 → later Unity 6.x → CoreCLR 6.8). Routing through a shim keeps
    ...
    ///   • <see cref="UnityFindObjectsCompat"/> — FindObjectsByType signature changes (6000.5)
    ...
    ///                                            stable simulation-mode contract
    ...
    ///
    /// What does NOT belong in a shim: APIs that only support pre-Unity-6 editors, hot-path
    /// engine APIs (Transform.position, Vector3.*,
