...
- Python or `uv` not found:
  - Help: [UnityMCPBridge troubleshooting](../docs/guides/troubleshooting.md)
...
This package is MIT licensed. See [LICENSE.md](LICENSE.md) and
[THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md), both of which are included
